...
import com.diego.petshop.dto.PessoaDTO;
import com.diego.petshop.service.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<List<PessoaDTO>> findAll() {
		...
		List<PessoaDTO> pessoaDTOs = pessoas.stream().map(pessoaDTO -> new PessoaDTO(pessoaDTO)).collect(Collectors.toList());
